...
class Battlefield1Stats(models.Model):
    ...
    def get_fields(self):
        return [(field.get_attname_column()[1], getattr(self, field.name)) for field in Battlefield1Stats._meta.fields]
...
class Battlefield4Stats(models.Model):
    ...
    def get_fields(self):
        return [(field.get_attname_column()[1], getattr(self, field.name)) for field in Battlefield4Stats._meta.fields]
